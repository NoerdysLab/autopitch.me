...
export async function sendWelcomeEmail(opts: {
  ...
  await deliver({
    to: opts.to,
    subject: "Your autopitch.me page is live",
...
Your autopitch.me page is live:

  https://autopitch.me/${handle}
...
<html><body style="margin:0;padding:0;background:#f8f7f4;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#1a1a1e;">
  <div style="max-width:480px;margin:0 auto;padding:48px 24px;">
    ...
    <div style="background:#ffffff;border:1px solid #e8e6e1;border-radius:16px;padding:20px;text-align:center;font-size:18px;font-weight:500;margin-bottom:32px;"><a href="https://autopitch.me/${handle}" style="color:#1a1a1e;text-decoration:none;">autopitch.me/${escapeHtml(handle)}</a></div>
